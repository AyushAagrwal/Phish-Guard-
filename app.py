...
def main():
    ...
    st.header('PhishGuard')
    # st.markdown("<h1>Streamlit</h1>", anchor_in_texts=False)

    url = st.text_input('',placeholder='Enter the URL to check if it is a phishing website or not').strip()
    result = ""
